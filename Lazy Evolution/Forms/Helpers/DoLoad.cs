...
namespace LazyEvo.Forms.Helpers
{
    internal class DoLoad
    {
        ...
        private static void LoadTheShit()
        {
            ...
            Logging.Write("Lazybot Re-Evolution by mckemo, demoniste, z0yb3r");
            Logging.Write("Mainthanks for this awesome bot goes to Arutha532");
            Logging.Write("LazyBot is free and open source software!");
            Logging.Write("Keys should be placed on bar 1-6 and position 1-9!");
            Logging.Write("Check ownedcore.com for news and Updates");
            LoadNow();
        }
